...
public class Robot {
	...
	protected static Logs logs = new Logs();
...
//		System.out.print(this.logs);
    ...
    public void collision(Robot autre) {
		this.logs.add("collision", this, autre);
	...
	private void direBonjour(Robot autre) {
		try {
			LogLine log = Robot.logs.trouveLigne(this,autre);
			System.out.println("Rebonjour, on s'est déjà croisé le " + log.date);
		} catch (Exception e) {
