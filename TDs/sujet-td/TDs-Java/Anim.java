...
public class Anim {
	...
	robots[0] = new Robot("Images/mini1.png", 80, 100, plat, new Color(180, 0, 180)) ;
	robots[1] = new Robot("Images/mini2.png", 480, 250, plat, new Color(180, 255, 180)) ;
	robots[2] = new Robot("Images/mini3.png", 280, 400, plat, new Color(180, 180, 0)) ;
	robots[3] = new Robot("Images/mini3.png", 100, 400, plat, new Color(0, 0, 0)) ;
